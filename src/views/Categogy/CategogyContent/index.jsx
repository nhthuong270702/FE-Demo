                                ...
                                <div className="section_panel d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div className="section_tags ml-auto">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="category.html">style hunter</a>
                                            </li>
                                            <li>
                                                <a href="category.html">vogue</a>
                                            </li>
                                            <li>
                                    ...
                                    <div className="section_panel_more">
                                        <ul>
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="category.html">new look 2018</a>
                                                    </li>
                                                    <li>
                                                        <a href="category.html">street fashion</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="category.html">celebrities</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                    ...
                                    <div className="grid clearfix">
                                        ...
                                        <div className="card card_default card_small_with_background grid-item">
                                            <div
                                                ...
                                                style={{ backgroundImage: "url(../../../assets/images/post_11.jpg)" }}
                                            />
                                            <div className="card-body">
                                                <div className="card-title card-title-small">
                                                    <a href="post.html">
                                        ...
                                        <div className="card card_default card_small_with_background grid-item">
                                            <div
                                                className="card_background"
                                                style={{ backgroundImage: "url(../../../assets/images/post_16.jpg)" }}
                                            />
                                            <div className="card-body">
                                                <div className="card-title card-title-small">
                                                    <a href="post.html">
                                        ...
                                        <div className="card card_default card_default_with_background grid-item">
                                            <div
                                                className="card_background"
                                                style={{ backgroundImage: "url(../../../assets/images/post_12.jpg)" }}
                                            />
                                            <div className="card-body">
                                                <div className="card-title card-title-small">
                                                    <a href="post.html">
                                        ...
                                        <div className="card card_default card_default_with_background grid-item">
                                            <div
                                                className="card_background"
                                                style={{ backgroundImage: "url(../../../assets/images/post_6.jpg)" }}
                                            />
                                            <div className="card-body">
                                                <div className="card-title card-title-small">
                                                    <a href="post.html">
                                        ...
                                        <div className="card card_default card_small_with_background grid-item">
                                            <div
                                                className="card_background"
                                                style={{ backgroundImage: "url(../../../assets/images/post_19.jpg)" }}
                                            />
                                            <div className="card-body">
                                                <div className="card-title card-title-small">
                                                    <a href="post.html">
                                        ...
                                        <div className="card card_default card_small_with_background grid-item">
                                            <div
                                                className="card_background"
                                                style={{ backgroundImage: "url(../../../assets/images/post_4.jpg)" }}
                                            />
                                            <div className="card-body">
                                                <div className="card-title card-title-small">
                                                    <a href="post.html">
                                        ...
                                        <div className="card card_default card_small_with_background grid-item">
                                            <div
                                                className="card_background"
                                                style={{ backgroundImage: "url(../../../assets/images/post_21.jpg)" }}
                                            />
                                            <div className="card-body">
                                                <div className="card-title card-title-small">
                                                    <a href="post.html">
                                        ...
                                        <div className="card card_default card_default_with_background grid-item">
                                            <div
                                                className="card_background"
                                                style={{ backgroundImage: "url(../../../assets/images/post_23.jpg)" }}
                                            />
                                            <div className="card-body">
                                                <div className="card-title card-title-small">
                                                    <a href="post.html">
                                        ...
                                        <div className="card card_default card_default_with_background grid-item">
                                            <div
                                                className="card_background"
                                                style={{ backgroundImage: "url(../../../assets/images/post_24.jpg)" }}
                                            />
                                            <div className="card-body">
                                                <div className="card-title card-title-small">
                                                    <a href="post.html">
...
export default CategogyContent;