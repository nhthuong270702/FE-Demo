            ...
            <div className="home_slider_container">
                    ...
                    <div className="owl-item">
                        ...
                        <div className="similar_posts_container">
                            ...
                            <div className="home_slider_next_container">
                                <div
                                    className="home_slider_next"
                                    style={{ backgroundImage: "url(../../../assets/images/home_slider_next.jpg)" }}
                                >
                                    ...
                                    <div className="home_slider_next_content trans_400">
                                        ...
                                        <div className="home_slider_next_link">
                                            How Did van Gogh’s Turbulent Mind Depict One of the Most
                                            Complex Concepts in Physics?
                                        </div>
                                    </div>
                ...
                <div className="custom_nav_container home_slider_nav_container">
                    ...
                    <ul id="custom_dots" className="custom_dots custom_dots_home_slider">
                        <li className="custom_dot custom_dot_home_slider active">
                            <span />
                        </li>
                        <li className="custom_dot custom_dot_home_slider">
                            <span />
                        </li>
                        <li className="custom_dot custom_dot_home_slider">
                            <span />
